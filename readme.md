...
1. 前往 [Releases](https://github.com/YOUR_USERNAME/btc-ticker/releases) 页面
...
```bash
# 1. 克隆仓库
git clone https://github.com/YOUR_USERNAME/btc-ticker.git
cd btc-ticker
...
- 问题反馈: [GitHub Issues](https://github.com/YOUR_USERNAME/btc-ticker/issues)
